...
void main() => runApp(const Appbardart());

class Appbardart extends StatelessWidget {
  const Appbardart({super.key});

  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      theme: ThemeData(
        colorSchemeSeed: const Color.fromARGB(255, 175, 129, 76),
        useMaterial3: true,
      ),
