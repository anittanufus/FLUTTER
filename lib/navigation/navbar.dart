...
void main() => runApp(const navdart());

class navdart extends StatelessWidget {
  const navdart({super.key});
...
class _BottomNavigationExampleState extends State<BottomNavigationExample> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: const Color.fromARGB(255, 175, 135, 76),
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        selectedItemColor: const Color.fromARGB(255, 175, 135, 76), // Warna tab aktif
